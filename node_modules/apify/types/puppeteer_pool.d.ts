...
declare class PuppeteerPool {
    ...
    launchPuppeteerOptions: LaunchPuppeteerOptions;
    launchPuppeteerFunction: ({ proxyUrl }: {
        proxyUrl: any;
    }) => Promise<Browser>;
    ...
    browsersToInstancesMap: WeakMap<object, any>;
     ...
     * @ignore
     */
    _initBrowser(instance: PuppeteerInstance): Promise<void>;
    /**
     ...
     * @ignore
     */
    _getBrowserInstance(page: Page): PuppeteerInstance;
}
...
declare class PuppeteerInstance {
    ...
    activePages: number;
    totalPages: number;
    browserPromise: Promise<any> | null;
