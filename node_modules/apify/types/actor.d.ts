...
export function call(actId: string, input?: object | undefined, options?: {
    contentType?: string;
    token?: string;
    memoryMbytes?: number;
    timeoutSecs?: number;
...
export function callTask(taskId: string, input?: object | undefined, options?: {
    token?: string;
    memoryMbytes?: number;
    timeoutSecs?: number;
    build?: string;
...
export function metamorph(targetActorId: string, input?: object | undefined, options?: {
    contentType?: string;
    build?: string;
