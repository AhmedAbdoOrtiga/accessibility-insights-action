...
declare const exportedUtils: {
    ...
    createRequestDebugInfo: (request: Request | import("./request").RequestOptions, response?: import("http").IncomingMessage | import("puppeteer").Response | undefined, additionalFields?: Object | undefined) => object;
    ...
    puppeteer: {
        ...
        gotoExtended: (page: import("puppeteer").Page, request: globalThis.Request, gotoOptions?: import("puppeteer").DirectNavigationOptions | undefined) => Promise<import("puppeteer").Response | null>;
...
export { main, getEnv, call, callTask, metamorph, getMemoryInfo, isAtHome, newClient, addWebhook, AutoscaledPool, BasicCrawler, CheerioCrawler, pushData, openDataset, events, initializeEvents, stopEvents, getValue, setValue, getInput, openKeyValueStore, launchPuppeteer, PuppeteerPool, PuppeteerCrawler, PseudoUrl, Request, RequestList, openRequestList, openRequestQueue, openSessionPool, createProxyConfiguration, LiveViewServer, Session, exportedUtils as utils };
...
export { ProxyConfiguration, ProxyConfigurationOptions, ProxyInfo } from "./proxy_configuration";
...
export { KeyValueStore, KeyConsumer } from "./storages/key_value_store";
