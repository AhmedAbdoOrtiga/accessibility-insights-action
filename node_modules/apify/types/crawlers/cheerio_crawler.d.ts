...
declare class CheerioCrawler {
     ...
     * @ignore
     */
    _handleRequestFunction(crawlingContext: {
        request: Request;
        autoscaledPool: AutoscaledPool;
        session?: Session;
    }): Promise<object>;
     ...
     * @ignore
     */
    _requestFunction({ request, session, proxyUrl }: {
        request: Request;
        session: Session;
        proxyUrl: string;
    }): Promise<any>;
     ...
     * @ignore
     */
    _parseResponse(request: Request, responseStream: any): Promise<object>;
    /**
     ...
     * @ignore
     */
    _getRequestOptions(request: Request, session?: Session | undefined, proxyUrl?: string | undefined): any;
