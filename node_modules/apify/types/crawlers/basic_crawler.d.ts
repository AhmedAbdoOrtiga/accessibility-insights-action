...
declare class BasicCrawler {
    ...
    handleFailedRequestFunction: ({ request }: HandleFailedRequestInput) => void;
    maxRequestRetries: number;
    ...
    sessionPoolOptions: {
         ...
         */
        sessionOptions?: import("../session_pool/session").SessionOptions;
        /**
         ...
         */
        createSessionFunction?: import("../session_pool/session_pool").CreateSession;
    };
    useSessionPool: boolean;
     ...
     * @ignore
     */
    _fetchNextRequest(): Promise<Request | null>;
    /**
     ...
     * @ignore
     */
    _defaultIsFinishedFunction(): Promise<boolean>;
    /**
     ...
     * @ignore
     */
    _requestFunctionErrorHandler(error: Error, crawlingContext: object, source: RequestList | RequestQueue): Promise<boolean | void | QueueOperationInfo>;
    /**
