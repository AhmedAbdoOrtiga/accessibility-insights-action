...
export function getValue(key: string): Promise<string | object | Buffer | null>;
export function setValue(key: string, value: object, options?: {
    contentType?: string;
} | undefined): Promise<void>;
export function getInput(): Promise<string | object | Buffer | null>;
/**
 * User-function used in the  {@link KeyValueStore#forEachKey} method.
 */
export type KeyConsumer = (key: string, index: number, info: object, size: number) => any;
