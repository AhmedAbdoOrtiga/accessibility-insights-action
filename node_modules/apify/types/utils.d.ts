...
export function addTimeoutToPromise(promise: Promise<object>, timeoutMillis: number, errorMessage: string): Promise<object>;
...
import * as ApifyClient from "../types-apify/apify-client";
...
declare function createRequestDebugInfo(request: Request | RequestOptions, response?: IncomingMessage | PuppeteerResponse | undefined, additionalFields?: Object | undefined): object;
