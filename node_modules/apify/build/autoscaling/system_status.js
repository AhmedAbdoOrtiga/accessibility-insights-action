...
const snapshotter_1 = require("./snapshotter"); // eslint-disable-line import/no-duplicates
...
class SystemStatus {
    ...
    constructor(options = {}) {
        ...
        const { currentHistorySecs = 5, maxMemoryOverloadedRatio = 0.2, maxEventLoopOverloadedRatio = 0.4, maxCpuOverloadedRatio = 0.4, maxClientOverloadedRatio = 0.3, snapshotter, } = options;
    ...
    _isSampleOverloaded(sample, ratio) {
        ...
        const wAvg = utils_1.weightedAvg(values, weights);
        return {
