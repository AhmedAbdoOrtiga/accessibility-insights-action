...
const snapshotter_1 = require("./snapshotter"); // eslint-disable-line import/named,no-unused-vars
const system_status_1 = require("./system_status"); // eslint-disable-line import/named,no-unused-vars
...
class AutoscaledPool {
    ...
    set minConcurrency(value) {
        ow_1.default(value, ow_1.default.number);
    ...
    async run() {
        ...
        this.autoscaleInterval = utilities_1.betterSetInterval(this._autoscale, this.autoscaleIntervalMillis);
        ...
        this.maybeRunInterval = utilities_1.betterSetInterval(this._maybeRunTask, this.maybeRunIntervalMillis);
        try {
    ...
    async _destroy() {
        this.resolve = null;
        this.reject = null;
        utilities_1.betterClearInterval(this.autoscaleInterval);
        utilities_1.betterClearInterval(this.maybeRunInterval);
        if (this.snapshotter)
