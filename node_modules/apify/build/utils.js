 ...
 */
exports.newStorageLocal = (options = {}) => {
    const { storageDir = process.env[consts_1.ENV_VARS.LOCAL_STORAGE_DIR] || consts_1.LOCAL_ENV_VARS[consts_1.ENV_VARS.LOCAL_STORAGE_DIR], } = options;
 ...
 * @ignore
 */
exports.apifyStorageLocal = exports.newStorageLocal();
/**
...
exports.addTimeoutToPromise = (promise, timeoutMillis, errorMessage) => {
    return new Promise((resolve, reject) => {
        ow_1.default(promise, ow_1.default.promise);
        ow_1.default(timeoutMillis, ow_1.default.number);
        ow_1.default(errorMessage, ow_1.default.string);
...
const createRequestDebugInfo = (request, response = {}, additionalFields = {}) => {
    ow_1.default(request, ow_1.default.object);
    ow_1.default(response, ow_1.default.object);
    ow_1.default(additionalFields, ow_1.default.object);
    return {
...
exports.printOutdatedSdkWarning = () => {
    if (process.env[DISABLE_OUTDATED_WARNING])
        return;
...
exports.parseContentTypeFromResponse = (response) => {
    ow_1.default(response, ow_1.default.object.partialShape({
        url: ow_1.default.string.url,
...
exports.waitForRunToFinish = async (options) => {
    ...
    while (shouldRepeat()) {
        const waitForFinish = waitSecs
            ...
            : 999999;
        run = await exports.apifyClient.run(runId, actorId).waitForFinish({ waitForFinish }); // TODO waitForFinish
