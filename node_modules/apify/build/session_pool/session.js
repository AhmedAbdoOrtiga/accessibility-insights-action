...
class Session {
    ...
    constructor(options) {
        ...
        const { sessionPool, id = `session_${utilities_1.cryptoRandomObjectId(10)}`, cookieJar = new tough_cookie_1.CookieJar(), maxAgeSecs = DEFAULT_SESSION_MAX_AGE_SECS, userData = {}, maxErrorScore = 3, errorScoreDecrement = 0.5, createdAt = new Date(), usageCount = 0, errorScore = 0, maxUsageCount = 50, log = utils_log_1.default, } = options;
    ...
    setCookiesFromResponse(response) {
        try {
            const cookies = session_utils_1.getCookiesFromResponse(response).filter((c) => c);
