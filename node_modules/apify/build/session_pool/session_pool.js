...
class SessionPool extends events_1.EventEmitter {
    ...
    constructor(options = {}) {
        ...
        const { maxPoolSize = 1000, persistStateKeyValueStoreId, persistStateKey = 'SDK_SESSION_POOL_STATE', createSessionFunction, sessionOptions = {}, log = utils_log_1.default, } = options;
        super();
     ...
     */
    async initialize() {
        this.keyValueStore = await key_value_store_1.openKeyValueStore(this.persistStateKeyValueStoreId);
 ...
 * @function
 */
exports.openSessionPool = async (sessionPoolOptions) => {
