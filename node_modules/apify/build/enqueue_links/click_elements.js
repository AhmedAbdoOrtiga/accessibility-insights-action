...
async function enqueueLinksByClickingElements(options) {
    ...
    let requestOptions = shared_1.createRequestOptions(interceptedRequests);
    if (transformRequestFunction) {
        requestOptions = requestOptions.map(transformRequestFunction).filter((r) => !!r);
    }
    const requests = shared_1.createRequests(requestOptions, pseudoUrlInstances);
...
async function clickElementsAndInterceptNavigationRequests(options) {
    ...
    await puppeteer_request_interception_1.addInterceptRequestHandler(page, onInterceptedRequest);
    ...
    await puppeteer_request_interception_1.removeInterceptRequestHandler(page, onInterceptedRequest);
