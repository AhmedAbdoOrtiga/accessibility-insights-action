...
const puppeteer_pool_1 = require("../puppeteer_pool"); // eslint-disable-line import/no-duplicates
...
class PuppeteerCrawler {
    ...
    constructor(options) {
        ow_1.default(options, ow_1.default.object.exactShape({
            ...
            gotoTimeoutSecs: ow_1.default.optional.number,
            ...
            puppeteerPoolOptions: ow_1.default.optional.object,
        ...
        const { handlePageFunction, gotoFunction = this._defaultGotoFunction, handlePageTimeoutSecs = 60, gotoTimeoutSecs = 60, 
        // AutoscaledPool shorthands
        maxConcurrency, minConcurrency, 
        // BasicCrawler options
        requestList, requestQueue, maxRequestRetries, maxRequestsPerCrawl, handleFailedRequestFunction = this._defaultHandleFailedRequestFunction.bind(this), autoscaledPoolOptions, 
        // PuppeteerPool options and shorthands
        puppeteerPoolOptions, launchPuppeteerFunction, launchPuppeteerOptions, sessionPoolOptions = {}, persistCookiesPerSession = false, useSessionPool = false, proxyConfiguration, } = options;
        ...
        this.log = utils_log_1.default.child({ prefix: 'PuppeteerCrawler' });
    ...
    async run() {
        ...
        this.puppeteerPool = new puppeteer_pool_1.default(this.puppeteerPoolOptions);
        try {
    ...
    async _handleRequestFunction(crawlingContext) {
        ...
        try {
            ...
            await utils_1.addTimeoutToPromise(this.handlePageFunction(crawlingContext), this.handlePageTimeoutMillis, `handlePageFunction timed out after ${this.handlePageTimeoutMillis / 1000} seconds.`);
            if (session)
                session.markGood();
        }
        finally {
    ...
    async _defaultGotoFunction({ page, request }) {
        return puppeteer_utils_1.gotoExtended(page, request, { timeout: this.gotoTimeoutMillis });
    }
    /**
     * @param {Object} options
