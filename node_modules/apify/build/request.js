...
class Request {
     ...
     */
    constructor(options) {
        ow_1.default(options, 'RequestOptions', ow_1.default.object);
        ow_1.default(options.url, 'RequestOptions.url', ow_1.default.string.url);
        ...
        Object.keys(options).forEach((prop) => {
            ...
            if (predicate) {
                ow_1.default(value, `RequestOptions.${prop}`, predicate);
    ...
    _computeUniqueKey({ url, method, payload, keepUrlFragment, useExtendedUniqueKey }) {
        ...
        const normalizedUrl = utilities_1.normalizeUrl(url, keepUrlFragment) || url; // It returns null when url is invalid, causing weird errors.
