 ...
 */
exports.addInterceptRequestHandler = async (page, handler) => {
    ow_1.default(page, ow_1.default.object.hasKeys('goto', 'evaluate'));
    ow_1.default(handler, ow_1.default.function);
 ...
 */
exports.removeInterceptRequestHandler = async (page, handler) => {
    ow_1.default(page, ow_1.default.object.hasKeys('goto', 'evaluate'));
    ow_1.default(handler, ow_1.default.function);
