...
const ListDictionary = require("apify-shared/list_dictionary");
const consts_1 = require("apify-shared/consts");
const utilities_1 = require("apify-shared/utilities");
const ow_1 = require("ow");
const request_1 = require("../request"); // eslint-disable-line import/named,no-unused-vars
 ...
 * @ignore
 */
exports.getRequestId = (uniqueKey) => {
    const str = crypto
        .createHash('sha256')
        .update(uniqueKey)
        .digest('base64')
...
class RequestQueue {
    ...
    constructor(options) {
        ...
        this.clientKey = utilities_1.cryptoRandomObjectId();
    ...
    async addRequest(requestLike, options = {}) {
        ow_1.default(requestLike, ow_1.default.object.partialShape({
        ...
        const cacheKey = exports.getRequestId(request.uniqueKey);
    ...
    async markRequestHandled(request) {
        ...
        this._cacheRequest(exports.getRequestId(request.uniqueKey), queueOperationInfo);
    ...
    async _ensureHeadIsNonEmpty(ensureConsistency = false, limit = Math.max(this.inProgressCount() * exports.QUERY_HEAD_BUFFER, exports.QUERY_HEAD_MIN_LENGTH), iteration = 0) {
        ...
        if (!this.queryQueueHeadPromise) {
            ...
            this.queryQueueHeadPromise = this.client
                ...
                items.forEach(({ id: requestId, uniqueKey }) => {
                    ...
                    this._cacheRequest(exports.getRequestId(uniqueKey), { requestId, wasAlreadyHandled: false });
                });
        ...
        if (shouldRepeatForConsistency) {
            ...
            await utils_1.sleep(delayMillis);
        }
    ...
    async drop() {
        ...
        const manager = new storage_manager_1.default(RequestQueue);
 ...
 * @function
 */
exports.openRequestQueue = async (queueIdOrName, options = {}) => {
    ow_1.default(queueIdOrName, ow_1.default.optional.string);
    ow_1.default(options, ow_1.default.object.exactShape({
