 ...
 * @ignore
 */
exports.maybeStringify = (value, options) => {
    ...
    if (options.contentType === null || options.contentType === undefined) {
        ...
        try {
            ...
            value = utilities_1.jsonStringifyExtended(value, null, 2);
        }
        catch (e) {
...
class KeyValueStore {
     ...
     */
    async getValue(key) {
        ow_1.default(key, ow_1.default.string.nonEmpty);
    ...
    setValue(key, value, options = {}) {
        ow_1.default(key, ow_1.default.string.nonEmpty);
        ow_1.default(key, ow_1.default.string.validate((k) => ({
            validator: ow_1.default.isValid(k, ow_1.default.string.matches(regexs_1.KEY_VALUE_STORE_KEY_REGEX)),
    ...
    async drop() {
        ...
        const manager = new storage_manager_1.default(KeyValueStore);
    ...
    async forEachKey(iteratee, options = {}, index = 0) {
        ...
        ow_1.default(iteratee, ow_1.default.function);
        ow_1.default(options, ow_1.default.object.exactShape({
 ...
 * @function
 */
exports.openKeyValueStore = async (storeIdOrName, options = {}) => {
    ow_1.default(storeIdOrName, ow_1.default.optional.string);
    ow_1.default(options, ow_1.default.object.exactShape({
...
exports.getValue = async (key) => {
    const store = await exports.openKeyValueStore();
 ...
 * @function
 */
exports.setValue = async (key, value, options) => {
    const store = await exports.openKeyValueStore();
 ...
 * @function
 */
exports.getInput = async () => exports.getValue(process.env[consts_1.ENV_VARS.INPUT_KEY] || consts_1.KEY_VALUE_STORE_KEYS.INPUT);
/**
