...
let Scanner = class Scanner {
    constructor(logger, scanner, reportGenerator, taskConfig, allProgressReporter, fileServer, promiseUtils, currentProcess) {
        this.logger = logger;
...
Scanner = __decorate([
    ...
    __param(1, inversify_1.inject(accessibility_insights_scan_1.AIScanner)),
    ...
    __metadata("design:paramtypes", [logger_1.Logger,
        accessibility_insights_scan_1.AIScanner,
        ...
        promise_utils_1.PromiseUtils, Object])
], Scanner);
