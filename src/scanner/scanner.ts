...
import { ScanArguments, CrawlerCommandRunner } from 'accessibility-insights-scan';
...
export class Scanner {
    constructor(
        ...
        @inject(CrawlerCommandRunner) private readonly crawler: CrawlerCommandRunner,
    ...
    private async invokeScan(): Promise<void> {
        ...
        try {
            ...
            const scanArgs: ScanArguments = {
                url: scanUrl,
                chromePath: chromePath,
                sourcePath: axeCoreSourcePath,
            };

            await this.crawler.runCommand(scanArgs);
        } catch (error) {
